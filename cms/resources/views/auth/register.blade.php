                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> 新規登録
                                </button><br>
                                <a href="{{ url('/auth/github')}}" class="btn btn-github">
                                    <i class="fa fa-github"></i> Githubログイン</a> 
                                <a href="{{ url('/auth/twitter')}}" class="btn btn-twitter">
                                    <i class="fa fa-twitter"></i> Twitterログイン</a>
                                <a href="{{ url('/auth/facebook')}}" class="btn btn-facebook">
                                    <i class="fa fa-facebook"></i> Facebookログイン</a>
                                <a href="{{ url('/auth/google')}}" class="btn btn-google">
                                    <i class="fa fa-google"></i> googleログイン</a>
                            </div>
                        </div>
                    </form>
                </div>
